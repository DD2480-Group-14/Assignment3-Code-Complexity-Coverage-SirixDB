...
public final class JsonIntegrationTest extends AbstractJsonTest {
  ...
  public void testDescendantDerefExprWithOnePathMatchAndChildMatch3() throws IOException {
    final String storeQuery = """
          jn:store('json-path1','mydoc.jn','{"test": "test string"}')
        """;
    final String query = """
          let $array := jn:doc('json-path1','mydoc.jn')
          return $array=>>test
  ...
  public void testDescendantDerefExprWithOnePathMatchAndDescendantMatch() throws IOException {
    final String storeQuery = """
          jn:store('json-path1','mydoc.jn','[{"foo": "test string"},{"foo": [{"test": "test blabla string"}]}]')
        """;
    final String query = """
          let $array := jn:doc('json-path1','mydoc.jn')
          return $array=>>test
  ...
  public void testDescendantDerefExprWithOnePathMatchAndDescendantMatch3() throws IOException {
    final String storeQuery = """
          jn:store('json-path1','mydoc.jn','{"bla": ["test string",{"test": "test blabla string"}]}')
        """;
    final String query = """
          let $array := jn:doc('json-path1','mydoc.jn')
          return $array=>>test
  ...
  public void testDescendantDerefExprWithOnePathMatchAndDescendantMatch4() throws IOException {
    final String storeQuery = """
          jn:store('json-path1','mydoc.jn','[{"foo": "test string"},{"foo": [{"test": "foo"}, [{"test": "test blabla string"}]]}]')
        """;
    final String query = """
          let $array := jn:doc('json-path1','mydoc.jn')
  ...
  public void testDescendantDerefExprWithDifferentPathsOnSameLevel() throws IOException {
    final String storeQuery = """
          jn:store('json-path1','mydoc.jn','{"tada": {"baz": [{"test": "test string"}],"foo": [{"test": "test blabla string"}]}}')
        """;
    final String query = """
          let $array := jn:doc('json-path1','mydoc.jn')
          return $array=>>test
  ...
  public void testDescendantDerefExprWithDifferentPathsOnSameLevel2() throws IOException {
    final String storeQuery = """
          jn:store('json-path1','mydoc.jn','[{"baz": [{"test": "test string"}]},{"foo": [{"test": "test blabla string"}]}]')
        """;
    final String query = """
          let $array := jn:doc('json-path1','mydoc.jn')
          return $array=>>test
  ...
  public void testDescendantDerefExprWithDifferentPaths() throws IOException {
    final String storeQuery = """
          jn:store('json-path1','mydoc.jn','[{"test": "test string"},{"test": [{"test": "test string"},{"test": "test string"}]}]')
        """;
    final String query = """
          let $array := jn:doc('json-path1','mydoc.jn')
          return $array=>>test
  ...
  public void testDescendantDerefExprWithDifferentPaths2() throws IOException {
    final String storeQuery = """
          jn:store('json-path1','mydoc.jn','[{"test": "test string"},{"test": [{"test": "test string"},{"test": {"test": {"test": "test string"}}}]}]')
        """;
    final String query = """
          let $array := jn:doc('json-path1','mydoc.jn')
          return $array=>>test
  ...
  public void testDescendantDerefExprWithDifferentPaths4() throws IOException {
    final String storeQuery = """
          jn:store('json-path1','mydoc.jn','[[],[{"test": true}],{"test": "test string"},{"test": [{"test": "test string"},{"test": {"test": {"test": "test string"}}}]},{}]')
        """;
    final String query = """
          let $array := jn:doc('json-path1','mydoc.jn')
          return $array[]=>>test
  ...
  public void testDescendantDerefExprWithDifferentPaths5() throws IOException {
    final String storeQuery = """
          jn:store('json-path1','mydoc.jn','{"tztz": [[],[{"test": true}],{"test": "test string"},{"test": [{"test": "test string"},{"test": {"test": {"test": "test string"}}}]},{}]}')
        """;
    final String query = """
          let $array := jn:doc('json-path1','mydoc.jn')
          return $array=>>test
  ...
  public void testDescendantDerefExprWithDifferentPaths8() throws IOException {
    final String storeQuery = """
          jn:store('json-path1','mydoc.jn','[{"test": "test string"},{"test": [[[{"blabla": "test blabla string"}]],{"blabla": "test blabla string"},[{"blabla": "test blabla string"}]]}]')
        """;
    final String query = """
          let $array := jn:doc('json-path1','mydoc.jn')
  ...
  public void testSimpleDeleteQuery() throws IOException {
    final String storeQuery = """
        ...
        """;
    final String query =
        "for $i in jn:doc('json-path1','mydoc.jn') where deep-equal($i.generic, 1) return delete json $i.location";
    final String openQuery = "jn:doc('json-path1','mydoc.jn')";
    final String assertion = """
          [{"generic":1}]
        """.strip();
  ...
  public void testTimeTravelQuery() throws IOException {
    ...
    final String updateQuery2 = """
          insert json {'generic': 1, 'location': {'state': 'CA', 'city': 'Los Angeles'}} into jn:doc('json-path1','mydoc.jn') at position 0
        """.strip();
    final String query =
        "let $node := sdb:select-item(jn:doc('json-path1','mydoc.jn'), 1) let $result := for $rev in jn:all-times($node) return if (not(exists(jn:previous($rev)))) then sdb:revision($rev) else if (sdb:hash($rev) ne sdb:hash(jn:previous($rev))) then sdb:revision($rev) else () return for $i in $result order by $i descending return $i";
    final String assertion = """
          3 2 1
        """.strip();
  ...
  public void testArray() throws IOException {
    final String storeQuery = """
          jn:store('json-path1','mydoc.jn','[{"generic": 1, "location": {"state": "CA", "city": "Los Angeles"}}, {"generic": 1, "location": {"state": "NY", "city": "New York"}}]')
        """;
    final String query =
        "for $i in jn:doc('json-path1','mydoc.jn') where deep-equal($i.generic, 1) return {$i,'nodeKey': sdb:nodekey($i)}";
    final String assertion = """
  ...
  public void testAppendToArray() throws IOException {
    final String storeQuery = "jn:store('json-path1','mydoc.jn','[\"foo\",true,false,null]')";
    final String updateQuery = """
          append json (1, 2, 3) into jn:doc('json-path1','mydoc.jn')
        """;
    final String openQuery = "jn:doc('json-path1','mydoc.jn')";
  ...
  public void testInsertIntoArray1() throws IOException {
    final String storeQuery = "jn:store('json-path1','mydoc.jn','[\"foo\",true,false,null]')";
    final String updateQuery = """
          insert json (1, 2, 3) into jn:doc('json-path1','mydoc.jn') at position 3
        """;
    final String openQuery = "jn:doc('json-path1','mydoc.jn')";
  ...
  public void testInsertIntoArray2() throws IOException {
    final String storeQuery = "jn:store('json-path1','mydoc.jn','[\"foo\",true,false,null]')";
    final String updateQuery = """
          insert json { "name": "keyword" } into jn:doc('json-path1','mydoc.jn') at position 3
        """;
    final String openQuery = "jn:doc('json-path1','mydoc.jn')";
...
//      """.strip(), "");
  ...
  public void testInsertIntoArrayAsFirst() throws IOException {
    final String storeQuery = "jn:store('json-path1','mydoc.jn','[\"foo\",true,false,null]')";
    final String updateQuery = """
          insert json (1, 2, 3) into jn:doc('json-path1','mydoc.jn') at position 0
        """;
    final String openQuery = "jn:doc('json-path1','mydoc.jn')";
  ...
  public void testInsertIntoObject() throws IOException {
    final String storeQuery = """
          jn:store('json-path1','mydoc.jn','{"foo": "bar"}')
        """;
    final String updateQuery = """
  ...
  public void testReplaceInObject() throws IOException {
    final String storeQuery = "jn:store('json-path1','mydoc.jn','{\"foo\": \"bar\", \"baz\": true}')";
    final String updateQuery = """
          replace json value of jn:doc('json-path1','mydoc.jn').baz with "yes"
        """;
    final String openQuery = "jn:doc('json-path1','mydoc.jn')";
  ...
  public void testArrayIteration() throws IOException {
    final String storeQuery =
        "jn:store('json-path1','mydoc.jn','[{\"key\":0,\"value\":true},{\"key\":\"hey\",\"value\":false}]')";
    final String openQuery =
        "for $i in jn:doc('json-path1','mydoc.jn') where deep-equal($i.key, 0) return { $i, \"nodekey\": sdb:nodekey($i) }";
  ...
  public void testNesting6() throws IOException {
    ...
    final String storeQuery = String.format("jn:load('json-path1','mydoc.jn','%s')", docUri);
    final String indexQuery =
        "let $doc := jn:doc('json-path1','mydoc.jn') let $stats := jn:create-path-index($doc, ('/paths/\\/consolidated_screening_list\\/search/get','/paths/\\/consolidated_screening_list\\/search/get/parameters/[]/name')) return {\"revision\": sdb:commit($doc)}";
    final String openQuery = """
        for $i in jn:doc('json-path1','mydoc.jn').paths."/consolidated_screening_list/search".get
  ...
  public void testNesting17() throws IOException {
    ...
    final String storeQuery = String.format("jn:load('json-path1','mydoc.jn','%s')", docUri);
    final String indexQuery =
        "let $doc := jn:doc('json-path1','mydoc.jn') let $stats := jn:create-path-index($doc, ('/paths/\\/consolidated_screening_list\\/search/get')) return {\"revision\": sdb:commit($doc)}";
    final String openQuery = """
        for $i in jn:doc('json-path1','mydoc.jn').paths."/consolidated_screening_list/search".get
        let $j := $i.parameters[].name
        return for $k in $j
  ...
  public void testNesting18() throws IOException {
    ...
    final String storeQuery = String.format("jn:load('json-path1','mydoc.jn','%s')", docUri);
    final String indexQuery =
        "let $doc := jn:doc('json-path1','mydoc.jn') let $stats := jn:create-path-index($doc, ('/pathx')) return {\"revision\": sdb:commit($doc)}";
    final String openQuery = """
        for $i in jn:doc('json-path1','mydoc.jn').paths."/consolidated_screening_list/search".get
        let $j := $i.parameters[].name
        return for $k in $j
  ...
  public void testNesting19() throws IOException {
    ...
    final String storeQuery = String.format("jn:load('json-path1','mydoc.jn','%s')", docUri);
    final String indexQuery =
        "let $doc := jn:doc('json-path1','mydoc.jn') let $stats := jn:create-path-index($doc, ('foo')) return {\"revision\": sdb:commit($doc)}";
    final String openQuery = """
        for $i in jn:doc('json-path1','mydoc.jn').paths."/consolidated_screening_list/search"
        let $j := $i.get
  ...
  public void testNesting20() throws IOException {
    ...
    final String storeQuery = String.format("jn:load('json-path1','mydoc.jn','%s')", docUri);
    final String indexQuery =
        "let $doc := jn:doc('json-path1','mydoc.jn') let $stats := jn:create-path-index($doc, ('/paths/\\/consolidated_screening_list\\/search','/paths/\\/consolidated_screening_list\\/search/get/parameters/[]/name')) return {\"revision\": sdb:commit($doc)}";
    final String openQuery = """
        for $i in jn:doc('json-path1','mydoc.jn').paths."/consolidated_screening_list/search"
        let $j := $i.get
        let $l := $j.parameters[].name
  ...
  public void testNesting22() throws IOException {
    ...
    final String storeQuery = String.format("jn:load('json-path1','mydoc.jn','%s')", docUri);
    final String indexQuery =
        "let $doc := jn:doc('json-path1','mydoc.jn') let $stats := jn:create-name-index($doc, 'foo') return {\"revision\": sdb:commit($doc)}";
    final String openQuery = "let $result := jn:doc('json-path1','mydoc.jn').sirix[].revision.foo return $result";
    test(storeQuery,
         indexQuery,
         openQuery,
  ...
  public void testNesting23() throws IOException {
    ...
    final String storeQuery = String.format("jn:load('json-path1','mydoc.jn','%s')", docUri);
    final String indexQuery =
        "let $doc := jn:doc('json-path1','mydoc.jn') let $stats := jn:create-name-index($doc, 'revision') return {\"revision\": sdb:commit($doc)}";
    final String openQuery = "let $result := jn:doc('json-path1','mydoc.jn').sirix[].revision.foo return $result";
    test(storeQuery,
         indexQuery,
         openQuery,
  ...
  public void testCreateAndScanNameIndex() throws IOException {
    ...
    final String storeQuery = String.format("jn:load('json-path1','mydoc.jn','%s')", docUri);
    final String indexQuery =
        "let $doc := jn:doc('json-path1','mydoc.jn') let $stats := jn:create-name-index($doc, ('foo','bar')) return {\"revision\": sdb:commit($doc)}";
